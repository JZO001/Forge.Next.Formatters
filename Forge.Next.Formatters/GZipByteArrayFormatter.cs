...
/// <summary>
/// GZipByteArrayFormatter is a class that implements the IGZipByteArrayFormatter interface for reading and writing GZip-compressed data.
/// </summary>
public class GZipByteArrayFormatter : IGZipByteArrayFormatter
{

    /// <summary>
    /// Gets or sets the buffer size used for reading and writing data in the GZipByteArrayFormatter. The default value is 8192 bytes.
    /// </summary>
    ...
    public Task<ErrorOr<byte[]?>> ReadAsync(Stream inputStream, CancellationToken cancellationToken = default)
    {
        ...
        return this.ProtectAsync<GZipByteArrayFormatter, byte[]?>(async (_, _) =>
        {
    ...
    public Task<ErrorOr<Success>> ReadAsync(Stream inputStream, Stream outputStream, CancellationToken cancellationToken = default)
    {
        ...
        return this.ProtectAsync<GZipByteArrayFormatter, Success>(async (_, _) =>
        {
